...
- **Pro Версия**: Неограниченное количество хостов. Доступна как ежемесячная подписка, годовая подписка или единоразовая покупка навсегда
- **Pro пользователи получают поддержку автономного использования**

---

## Скачать

> В связи с требованиями соответствия, NaviTerm распространяется в App Store как два отдельных приложения. Пожалуйста, выберите версию, соответствующую региону вашего App Store.

**Глобальная версия (по всему миру, кроме материкового Китая)**
