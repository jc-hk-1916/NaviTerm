...
- [dartssh2](https://github.com/TerminalStudio/dartssh2) - SSH-Client-Bibliothek für Dart
- [xterm.dart](https://github.com/TerminalStudio/xterm.dart) - Terminal-Emulator für Flutter
...
- **Pro-Version**: Unbegrenzte Hosts, verfügbar als monatliches Abonnement, jährliches Abonnement oder einmaliger lebenslanger Kauf
- **Pro-Nutzer genießen Offline-Nutzungsunterstützung**

---

## Herunterladen

> Aufgrund von Compliance-Anforderungen wird NaviTerm als zwei separate Apps im App Store vertrieben. Bitte wählen Sie die App, die zur Region Ihres App Stores passt.

**Global (Weltweit außer Festlandchina)**
...
1. Öffnen Sie den App Store auf Ihrem iPhone oder Mac;
2. Tippen Sie auf Ihr Profilsymbol > Code einlösen;
3. Fügen Sie den Promo-Code ein und bestätigen Sie;
4. Öffnen Sie die NaviTerm-App und das Abonnement wird automatisch aktiviert.

📎 [Klicken Sie hier, um verfügbare monatliche Promo-Codes anzuzeigen](promo-codes/monthly.txt)
📎 [Klicken Sie hier, um verfügbare jährliche Promo-Codes anzuzeigen](promo-codes/yearly.txt)

> Begrenzte Menge, wer zuerst kommt, mahlt zuerst. Keine Registrierung oder persönlichen Daten erforderlich.
